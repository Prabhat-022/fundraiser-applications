...
const Menu = () => {
    ...
    return (
        <>
            <div className="bg-gray-300 h-[90vh] overflow-y-scroll scrollbar-none w-full p-4  flex flex-col justify-between">
                <div className="">
                ...
                <button className="bg-orange-600 text-white py-2 px-4 rounded-lg transition-all duration-300 hover:bg-orange-700 cursor-pointer ">
                    Logout
                </button>
            </div>
